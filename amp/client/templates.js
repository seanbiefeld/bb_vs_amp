(function (root, factory) {
    ...
    templatizer["body"] = function tmpl_body() {
        return '<body><div class="container"><div class="navbar"><div class="navbar-inner"><a href="#" class="brand">demo</a><ul class="nav"><li><a href="/">home</a></li><li><a href="/collections">collection demo</a></li><li><a href="/info">more info</a></li></ul></div></div><main id="pages" role="page-container"></main></div></body>';
    };
